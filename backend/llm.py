...
Order: Groq (fast, strong) → Gemini (overflow) → Ollama (local, free safety net).
"""
...
def _provider_chain() -> list[tuple[str, str, str, str]]:
    ...
    if settings.gemini_api_key:
        chain.append(("gemini", "https://generativelanguage.googleapis.com/v1beta/openai/",
                      settings.gemini_api_key, "gemini-2.5-flash"))
